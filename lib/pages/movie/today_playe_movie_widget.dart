          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Row(
                children: <Widget>[
                  Stack(
                    alignment: Alignment.centerLeft,    // 中间居右对齐
                    children: <Widget>[
                      LaminatedImage(urls: urls, w: 90.0),
                      Positioned(
                        left: 90.0 / 3,
                        child: Image.asset('assets/images/ic_action_playable_video_s.png', width: 30.0, height: 30.0),
                      )
                    ],
                  ),
                  Expanded(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            ...
                            child: Text('全部 30 >', style: TextStyle(fontSize: 13, color: Colors.white)),
                          )
                        ],
                      ),
                    ),
        ...
        Row(
          ...
          children: <Widget>[
            Padding(
              ...
              child: Image.asset('assets/images/sofa.png', width: 15.0, height: 15.0,),
            ),
            Padding(
              padding: EdgeInsets.only(bottom: 10.0, right: 10.0, left: 5.0),
              child: Text('看电影', style: TextStyle(fontSize: 11, color: Colors.white)),
            )
          ],
        )
      ],
