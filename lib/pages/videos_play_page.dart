          ...
          Expanded(
            child: Container(
              ...
              child: ListView.builder(itemBuilder: (BuildContext context, int index) {
                if (index == 0) {
                  return Padding(padding: EdgeInsets.all(10.0), child: Row(children: <Widget>[
                    Expanded(
                      child: Text('观看预告片/片段/花絮', style: TextStyle(fontSize: 12.0),
                      ),
                    ),
              ...
              Padding(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Align(alignment: Alignment.center, child: getPlay(index))
                  ],
                ),
              ),
              Expanded(
                child: Padding(
                  padding: EdgeInsets.only(right: 10.0), child: Text(bean.title, softWrap: true, style: TextStyle(fontSize: 15.0),),
                ),
              ),
            ],
          ),
  ...
  getPlay(int index) {
    if (index == _showPlayIndex) {
      return Container(
        ...
        child: Icon(Icons.play_circle_outline, color: Colors.amber,
        ),
      );
    } else {
      return Container();
