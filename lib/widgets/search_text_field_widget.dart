  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Color.fromARGB(255, 237, 236, 237),borderRadius: BorderRadius.circular(24.0)
      ),
      child: TextField(
        onSubmitted: onSubmitted, // 内容回车提交
        onTap: onTab,
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: Icon(Icons.search, size: 25, color: Color.fromARGB(255, 128, 128, 128)) // 前缀图标
        ),
