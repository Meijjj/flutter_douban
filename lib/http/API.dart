...
import 'package:flutter_douban/bean/search_result_entity.dart';
import 'package:flutter_douban/bean/celebrity_entity.dart' as celebrity;
import 'package:flutter_douban/bean/celebrity_work_entity.dart';
...
class API {
  ...
  static const String TOP_250 = '/v2/movie/top250';   // top250
  ...
  void
  top250(RequestCallBack requestCallBack, {count = 250}) async {
  ...
  void getMovieDetail(subjectId, RequestCallBack requestCallBack) async {
    final result = await _request.get('/v2/movie/subject/$subjectId?apikey=0b2bdeda43b5688921839c8ecb20399b');
